                ...
                <div className="w-full space-y-8">
                    ...
                    <Collapsible className="p-6 rounded-xl border bg-white shadow overflow-hidden">
                        <div className="flex items-center justify-between space-x-4 w-full">
                            <div className="space-y-1.5 bg-muted/50">
                                <h3 className="font-bold tracking-tight items-center text-lg">
                                    {!blogDetails ? "Video Script" :
                                        scriptLoading ? "Generating video script..." :
                                            script ? "Click to view Video script" :
                                                "Preparing to generate video script..."}
                                </h3>
