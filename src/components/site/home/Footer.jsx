    ...
    <footer className="w-full flex bottom-0 flex-col">
        <div className="flex px-8 justify-between items-center bg-red-500 border-t border-t-slate-200 py-6 md:h-20 md:flex-row">
            ...
            <nav className="flex items-center text-sm gap-2">
                <a className="font-semibold text-sm hover:underline hover:underline-offset-4 hover:decoration-2 inline-flex justify-center items-center gap-2 rounded-3xl py-2.5 px-5" href="#">Privacy Policy</a>
                <a className="font-semibold text-sm hover:underline hover:underline-offset-4 hover:decoration-2 inline-flex justify-center items-center gap-2 rounded-3xl py-2.5 px-5" href="#">Terms of Service</a>
                <a href="#" className="font-semibold text-sm hover:underline hover:underline-offset-4 hover:decoration-2 inline-flex justify-center items-center gap-2 rounded-3xl py-2.5 px-5">Some Link</a>
                <a href="#" className="font-semibold text-sm hover:underline hover:underline-offset-4 hover:decoration-2 inline-flex justify-center items-center gap-2 rounded-3xl py-2.5 px-5">Some Link</a>
                <a href="#" className="font-semibold text-sm hover:underline hover:underline-offset-4 hover:decoration-2 inline-flex justify-center items-center gap-2 rounded-3xl py-2.5 px-5">Some Link</a>
            </nav>
